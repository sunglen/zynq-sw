 ...
 *  優先度データキュー機能の初期化
 */
extern void	initialize_pridataq(PCB *p_my_pcb);
 ...
 *  優先度データキューへのデータ送信
 */
extern bool_t	send_pridata(PCB *p_my_pcb, PDQCB *p_pdqcb,
										intptr_t data, PRI datapri);

/*
 *  優先度データキューからのデータ受信
 */
extern bool_t	receive_pridata(PCB *p_my_pcb, PDQCB *p_pdqcb,
										intptr_t *p_data, PRI *p_datapri);
