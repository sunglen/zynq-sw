...
#define DAIF_INT_MASK			UINT_C(0x0c0)
#define DAIF_I_BIT				UINT_C(0x080)
#define DAIF_F_BIT				UINT_C(0x040)
#ifdef TOPPERS_MACRO_ONLY
#define DAIFSCBIT(x)			((x) ALSR 6)
#endif /* TOPPERS_MACRO_ONLY */

/* msr daifset/daifclr でのビット*/
#define DAIFSC_I_BIT			UINT_C(2)
#define DAIFSC_F_BIT			UINT_C(1)
 ...
 */
#define AA64MMFR0_TGRAN4_MASK		(0xF << 28)
	#define AA64MMFR0_TGRAN4_OK			(0x0 << 28)
	#define AA64MMFR0_TGRAN4_NON		(0xF << 28)
#define AA64MMFR0_TGRAN64_MASK		(0xF << 24)
	#define AA64MMFR0_TGRAN64_OK		(0x0 << 24)
	#define AA64MMFR0_TGRAN64_NON		(0xF << 24)
#define AA64MMFR0_TGRAN16_MASK		(0xF << 20)
	#define AA64MMFR0_TGRAN16_OK		(0x1 << 20)
	#define AA64MMFR0_TGRAN16_NON		(0x0 << 20)
#define AA64MMFR0_BIGENDEL0_MASK	(0xF << 16)
#define AA64MMFR0_SNSMEM_MASK		(0xF << 12)
#define AA64MMFR0_BIGEND_MASK		(0xF << 8)
#define AA64MMFR0_ASIBITS_MASK		(0xF << 4)
#define AA64MMFR0_PARANGE_MASK		(0xF << 0)
	#define AA64MMFR0_PA4GB				(0x0 << 0)
	#define AA64MMFR0_PA64GB			(0x1 << 0)
	#define AA64MMFR0_PA1TB				(0x2 << 0)
 	#define AA64MMFR0_PA4TB				(0x3 << 0)
	#define AA64MMFR0_PA16TB			(0x4 << 0)
	#define AA64MMFR0_PA256TB			(0x5 << 0)
	#define AA64MMFR0_PA4PB				(0x6 << 0)
#endif	/* TOPPERS_32BIT_ABOVE_ADDR */
...
#if		(ADDR_SPACE_WIDTH == 52)
#error "ARMv8.2-LPA isn't supported."
#elif	(ADDR_SPACE_WIDTH != 32) && (ADDR_SPACE_WIDTH != 36) && (ADDR_SPACE_WIDTH != 40) &&		\
		(ADDR_SPACE_WIDTH != 42) && (ADDR_SPACE_WIDTH != 44) && (ADDR_SPACE_WIDTH != 48)
#error "ADDR_SPACE_WIDTH is invalid."
...
#define TT_BLK_SUPPORT_LEVEL	1
#if    ((64 - ADDR_SPACE_WIDTH) <= 24)
#define TT_FIRST_LEVEL			0
#elif  ((64 - ADDR_SPACE_WIDTH) <= 33)
#define TT_FIRST_LEVEL			1
#elif  ((64 - ADDR_SPACE_WIDTH) <= 42)
#define TT_FIRST_LEVEL			2
#else	/*  ((64 - ADDR_SPACE_WIDTH) <= 42) */
#define TT_FIRST_LEVEL			3
#endif	/* (64 - ADDR_SPACE_WIDTH) */

#elif  (TT_GRANULE_WIDTH == 14)
#define TT_BLK_SUPPORT_LEVEL	2
#if    ((64 - ADDR_SPACE_WIDTH) <= 16)
#define TT_FIRST_LEVEL			0
#elif  ((64 - ADDR_SPACE_WIDTH) <= 27)
#define TT_FIRST_LEVEL			1
#elif  ((64 - ADDR_SPACE_WIDTH) <= 38)
#define TT_FIRST_LEVEL			2
#else	/*  ((64 - ADDR_SPACE_WIDTH) <= 38) */
#define TT_FIRST_LEVEL			3
#endif	/* (64 - ADDR_SPACE_WIDTH) */
...
#error "TT_GRANULE_WIDTH must be 12 or 14 or 16."
#endif /* (TT_GRANULE_WIDTH == 16) */

#if    (TT_FIRST_LEVEL == 0)
#if    (ADDR_SPACE_WIDTH > TT_L0_SHIFT)
#define TT_FIRST_ENTRY_NUM		(1 << (ADDR_SPACE_WIDTH - TT_L0_SHIFT))
#else  /* (ADDR_SPACE_WIDTH > TT_L0_SHIFT) */
#define TT_FIRST_ENTRY_NUM		1
#endif /* (ADDR_SPACE_WIDTH > TT_L0_SHIFT) */

#elif	(TT_FIRST_LEVEL == 1)
#if    (ADDR_SPACE_WIDTH > TT_L1_SHIFT)
#define TT_FIRST_ENTRY_NUM		(1 << (ADDR_SPACE_WIDTH - TT_L1_SHIFT))
#else  /* (ADDR_SPACE_WIDTH > TT_L1_SHIFT) */
#define TT_FIRST_ENTRY_NUM		1
#endif /* (ADDR_SPACE_WIDTH > TT_L1_SHIFT) */

#elif	(TT_FIRST_LEVEL == 2)
#if    (ADDR_SPACE_WIDTH > TT_L2_SHIFT)
#define TT_FIRST_ENTRY_NUM		(1 << (ADDR_SPACE_WIDTH - TT_L2_SHIFT))
#else  /* (ADDR_SPACE_WIDTH > TT_L2_SHIFT) */
#define TT_FIRST_ENTRY_NUM		1
#endif /* (ADDR_SPACE_WIDTH > TT_L2_SHIFT) */

#else	/* (TT_FIRST_LEVEL == 2) */
#if    (ADDR_SPACE_WIDTH > TT_L3_SHIFT)
#define TT_FIRST_ENTRY_NUM		(1 << (ADDR_SPACE_WIDTH - TT_L3_SHIFT))
#else  /* (ADDR_SPACE_WIDTH > TT_L3_SHIFT) */
#define TT_FIRST_ENTRY_NUM		1
#endif /* (ADDR_SPACE_WIDTH > TT_L3_SHIFT) */
#endif /* (TT_FIRST_LEVEL == 0) */
...
#endif
#endif	/* TOPPERS_32BIT_ABOVE_ADDR */
#if		((TT_ENTRY_SIZE * TT_FIRST_ENTRY_NUM) > 64)
#define TT_FIRST_SIZE			(TT_ENTRY_SIZE * TT_FIRST_ENTRY_NUM)
#else	/* ((TT_ENTRY_SIZE * TT_FIRST_ENTRY_NUM) > 64) */
#define TT_FIRST_SIZE			64
#endif	/* ((TT_ENTRY_SIZE * TT_FIRST_ENTRY_NUM) > 64) */
...
enable_smp(void)
{
	...
	CPUECTLR_EL1_READ(reg64_val);
	if ((reg64_val & CPUECTLR_EL1_SMPEN) == 0) {
		reg64_val |= CPUECTLR_EL1_SMPEN;
